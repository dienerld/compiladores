...
export class Token {
  ...
  toPretty(): string {
    const colors: { [kind: number]: string } = {
      ...
      [TokenType.SLASH]: '\x1b[36m',
      [TokenType.STAR]: '\x1b[36m',
      [TokenType.BANG]: '\x1b[36m',
      [TokenType.BANG_EQUAL]: '\x1b[36m',
      [TokenType.EQUAL]: '\x1b[36m',
      [TokenType.EQUAL_EQUAL]: '\x1b[36m',
      [TokenType.GREATER]: '\x1b[36m',
      [TokenType.GREATER_EQUAL]: '\x1b[36m',
